...
```
python run.py lightning_datamodule=noisybwe lightning_datamodule.sensor=rigid_in_ear_microphone lightning_module=eben  ++trainer.check_val_every_n_epoch=15 ++trainer.max_epochs=500 lightning_module.generator.p=2 "trainer.devices=1\,"
```
