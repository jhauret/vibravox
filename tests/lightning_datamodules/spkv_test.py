...
class TestSPKVLightningDataModule:
    def test_dataset_test_return_type(self, spkv_lightning_datamodule_test_same_sensors_instance):
        test_dataset_a = spkv_lightning_datamodule_test_same_sensors_instance.test_dataset_a
        test_dataset_b = spkv_lightning_datamodule_test_same_sensors_instance.test_dataset_b
        ...
        assert isinstance(dataset_sample_a["sentence_id"], int)
        assert isinstance(dataset_sample_b["sentence_id"], int)
    ...
    def test_dataloader_test_returns_format(self, spkv_lightning_datamodule_test_same_sensors_instance):
        test_dataloder = spkv_lightning_datamodule_test_same_sensors_instance.test_dataloader()
