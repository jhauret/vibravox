...
class TestDiscriminatorMelganMultiScales:
    def test_forward_output_format(
        self, sample, discriminator_melgan_multiscales_instance
    ):
    ...
    def test_minimum_number_of_parameters(
        self, discriminator_melgan_multiscales_instance
    ):
